  ...
  <div class="flex justify-center items-center h-[800px] p-[20px]">
    <div class="min-h-[400px] w-[500px] bg-white rounded-lg">
      ...
      <div class="max-w-[400px] mt-[30px] mr-auto">
        <el-form ref="ruleFormRef" :model="form" status-icon :rules="rules" label-width="120px" size="large"
          class="p-[15px]">
          ...
          <el-form-item>
            <el-checkbox v-model="form.remember" label="Remember me" name="type" />
          </el-form-item>
          <el-form-item>
            <el-button class="max-[360px]:mb-[10px]" type="primary" @click="submitForm(ruleFormRef)">Submit</el-button>
